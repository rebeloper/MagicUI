...
public struct LoremPicsum {
    ...
    public static var foodAndDrink: Image {
        Image(foodAndDrinkName, bundle: Bundle(for: MagicUIBundleReference.self))
    }
    
    public static var backToSchool: Image {
        Image(backToSchoolName, bundle: Bundle(for: MagicUIBundleReference.self))
    }
    
    public static var nature: Image {
        Image(natureName, bundle: Bundle(for: MagicUIBundleReference.self))
    }
    
    public static var architecture: Image {
        Image(architectureName, bundle: Bundle(for: MagicUIBundleReference.self))
    }
    
    public static var business: Image {
        Image(businessName, bundle: Bundle(for: MagicUIBundleReference.self))
    }
    
    public static var fashion: Image {
        Image(fashionName, bundle: Bundle(for: MagicUIBundleReference.self))
    }
    
    public static var health: Image {
        Image(healthName, bundle: Bundle(for: MagicUIBundleReference.self))
    }
    
    public static var interior: Image {
        Image(interiorName, bundle: Bundle(for: MagicUIBundleReference.self))
    }
    
    public static var street: Image {
        Image(streetName, bundle: Bundle(for: MagicUIBundleReference.self))
    }
    
    public static var technology: Image {
        Image(technologyName, bundle: Bundle(for: MagicUIBundleReference.self))
    }
    
    public static var texture: Image {
        Image(textureName, bundle: Bundle(for: MagicUIBundleReference.self))
    }
    
    public static var travel: Image {
        Image(travelName, bundle: Bundle(for: MagicUIBundleReference.self))
    }
    
    public static var athletics: Image {
        Image(athleticsName, bundle: Bundle(for: MagicUIBundleReference.self))
    }
    
    public static var history: Image {
        Image(historyName, bundle: Bundle(for: MagicUIBundleReference.self))
    }
    
    public static var person0: Image {
        Image(person0Name, bundle: Bundle(for: MagicUIBundleReference.self))
    }
    
    public static var person1: Image {
        Image(person1Name, bundle: Bundle(for: MagicUIBundleReference.self))
    }
    
    public static var person2: Image {
        Image(person2Name, bundle: Bundle(for: MagicUIBundleReference.self))
    }
    
    public static var person3: Image {
        Image(person3Name, bundle: Bundle(for: MagicUIBundleReference.self))
    }
    
    public static var person4: Image {
        Image(person4Name, bundle: Bundle(for: MagicUIBundleReference.self))
    }
    
    public static var person5: Image {
        Image(person5Name, bundle: Bundle(for: MagicUIBundleReference.self))
    }
    
    public static var person6: Image {
        Image(person6Name, bundle: Bundle(for: MagicUIBundleReference.self))
    }
    
    public static var person7: Image {
        Image(person7Name, bundle: Bundle(for: MagicUIBundleReference.self))
    }
    
    public static var person8: Image {
        Image(person8Name, bundle: Bundle(for: MagicUIBundleReference.self))
    }
    
    public static var person9: Image {
        Image(person9Name, bundle: Bundle(for: MagicUIBundleReference.self))
    }
